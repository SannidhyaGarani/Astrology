  ...
  return (
    <div className="bg-[#FAF8F4] min-h-screen selection:bg-[#C9A14A]/20">
      <Breadcrumbs 
        ...
        subtitle="Connect directly with our engineering core to isolate custom telemetry layouts for commercial setups or corporate operations."
            ...
            >
              <div className="space-y-10">
                ...
                <div className="flex gap-6 items-start group">
                  ...
                  <div>
                    <span className="text-xs font-mono tracking-widest text-zinc-500 block mb-1 font-bold">// HQ_LOC_01</span>
                    <h4 className="font-['Cormorant_Garamond'] text-2xl text-[#111111] font-light tracking-tight mb-2">Corporate Headquarters</h4>
                ...
                <div className="flex gap-6 items-start group">
                  ...
                  <div>
                    <span className="text-xs font-mono tracking-widest text-zinc-500 block mb-1 font-bold">// COMMS_SECURE</span>
                    <h4 className="font-['Cormorant_Garamond'] text-2xl text-[#111111] font-light tracking-tight mb-2">Direct Line Secure</h4>
                    <a href="tel:+919312437037" className="text-zinc-700 text-lg font-light hover:text-[#C9A14A] transition-colors tracking-wide block">
                      +91 9312437037
                    </a>
                  </div>
                </div>
                ...
                <div className="flex gap-6 items-start group">
                  ...
                  <div>
                    <span className="text-xs font-mono tracking-widest text-zinc-500 block mb-1 font-bold">// DIGITAL_INBOUND</span>
                    <h4 className="font-['Cormorant_Garamond'] text-2xl text-[#111111] font-light tracking-tight mb-2">Inquiry Registry</h4>
                    <a href="mailto:info@vrihadvastu.com" className="text-zinc-700 text-lg font-light hover:text-[#C9A14A] transition-colors tracking-wide block">
                      info@vrihadvastu.com
                    </a>
                  </div>
                </div>
            ...
            >
              ...
              <form onSubmit={handleSubmit} className="space-y-10">
                ...
                <div className="grid md:grid-cols-2 gap-8 md:gap-10">
                  ...
                  />
                  <ContactField 
                    label="Corporate / Estate Name" 
                    placeholder="e.g., HighRise Research" 
                    name="company"
                    required={false}
                ...
                <ContactField 
                  label="Geographical Coordination / Site Address" 
                  placeholder="Provide state, region or grid sector details" 
                  name="address"
                ...
                <div className="flex flex-col gap-2.5 w-full">
                  ...
                  <textarea 
                    ...
                    onChange={handleChange}
                    required
                    placeholder="Elaborate on structural alignments, geopathic anomalies, or operational balancing required..."
                ...
                >
                  <span>Transmit Field Matrix</span>
              ...
              <p className="mt-6 text-center text-zinc-500 text-xs tracking-widest font-light font-mono font-bold">
                * All telemetry and field records are managed under absolute non-disclosure encryption metrics.
              </p>
            </motion.div>
          ...
          >
            ...
            <div className="absolute inset-0 flex items-center justify-center p-4">
              <div className="bg-white p-8 border border-[#C9A14A]/20 max-w-md text-center shadow-[0_20px_40px_rgba(0,0,0,0.02)]">
                <span className="text-[#C9A14A] font-mono text-[9px] tracking-[0.4em] block mb-2 uppercase">// Operational Reach</span>
                <h3 className="font-['Cormorant_Garamond'] text-3xl text-[#111111] font-light tracking-tight mb-2">Transnational Framework</h3>
                <p className="text-xs text-zinc-500 uppercase tracking-[0.2em] leading-relaxed">
                  Executing engineering layout architectures across Asia, Europe & the Middle Eastern territory zones.
                </p>
              </div>
            </div>
          </motion.div>
